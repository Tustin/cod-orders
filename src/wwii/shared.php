...
const DAILY_ORDER_CRITERIA_POSITION_X = 52;
const DAILY_ORDER_CRITERIA_POSITION_X = 319;

const WEEKLY_ORDER_TITLE_POSITION_X = DAILY_ORDER_TITLE_POSITION_X;
const WEEKLY_ORDER_TITLE_POSITION_Y = (DAILY_ORDER_TITLE_POSITION_X * 2) + ORDER_Y_DIFFERENCE;
